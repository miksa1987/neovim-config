...
A [Neovim](https://github.com/neovim/neovim) configuration using Lua. Different language servers available through the LSP protocol provide code completion and analysis.
...
## Other
This configuration is based on a programmer's config which I can't get to my head to remember, which was again based on some other config and so on. I will add link here when I find that repo again.
